...
export const CONSUMER_DEMO_ACTIONS = Object.freeze([
  ...
  'REPEAT_PROJECT', 'START_RESOLUTION', 'MATCH_INTENT', 'READ_STATUS', 'ANSWER_QUESTION',
...
const internalTerms = /\b(?:Survival Kernel|Semantic Runtime|KCL|Ollama|proofs?|candidates?|scores?|traces?|stack trace|authorization|x-mcir|cf-access)\b/i;
