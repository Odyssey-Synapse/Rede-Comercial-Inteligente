...
test("API CNPJ usa lookup V2 e TTL curto",()=>{
  const s=read("api/cnpj.js");
  assert.match(s,/AA_COMPANY_LOOKUP_V2/);
  assert.match(s,/COMPANY_LOOKUP_TTL_MINUTES/);
  assert.match(s,/source: "SERPRO_CNPJ_V2"/);
});
test("cliente possui timeout e x-request-tag",()=>{
