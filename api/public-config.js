export default function handler(req, res) {
  ...
  return res.status(200).json({
    ...
    privacyPolicyApproved: process.env.PRIVACY_POLICY_STATUS === "APPROVED",
    ...
    contactFormEnabled: !!(process.env.RESEND_API_KEY && process.env.RESEND_FROM_EMAIL && process.env.CONTACT_DESTINATION_EMAIL)
  });
}
